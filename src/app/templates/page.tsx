...
import { Search, Crown, Sparkles, Star } from "lucide-react";
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                {templates.length} ta shablon topildi
              </p>
            </div>
          ...
          <div className="flex gap-2 mt-4 overflow-x-auto pb-1">
            <Link
              href="/templates"
              className={`shrink-0 px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${!category ? "bg-purple-600 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
            >
              Hammasi
            </Link>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${styles.primaryColor}22, ${styles.primaryColor}44)`,
                    }}
                  >
                    ...
                    {template.isPremium && (
                      <div className="absolute top-3 right-3 bg-amber-500 text-white px-2 py-1 rounded-full text-xs font-semibold flex items-center gap-1 shadow-sm">
